...
@section('title', trans('broker.register.title'))
@section('page_title', trans('broker.register.title'))
@section('page_title_ico', trans('broker.register.title_ico'))

@section('content')
    <div class="content">
        <form class="form-horizontal col-lg-6" method="POST" enctype="multipart/form-data" action="{{ route('broker.registeraction') }}">
            {{ csrf_field() }}
            <p> {{trans('broker.register.desc')}} </p>
            <br>
            @if (session('success'))
            ...
            <div class="row form-group @if($errors->has('alias_name')) has-error @endif">
                ...
                <div class="col-lg-10">
                    <input class="form-control" type="text" id="alias_name" name="alias_name" value="{{ old('alias_name') }}">
                </div>
            </div>
